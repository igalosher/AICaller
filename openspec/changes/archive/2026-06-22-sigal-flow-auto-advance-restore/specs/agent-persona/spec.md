...
#### Scenario: Opening with niqqud pronunciation hints
- **WHEN** the configured `speak_opening` text includes niqqud on Sigal or the creator name
- **THEN** TTS receives that text so names are pronounced as intended
